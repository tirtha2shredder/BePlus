...
function requestCommunitySignUp(){

try{



	if (validateCommunitySignUp()){
		$("input").prop("disabled", true);
        $("button").prop("disabled", true);
		// Web service call here
    var req = window.localStorage.getItem("signUpCommunityRequest");

      $.ajax({
          type: "POST",
          url: "https://beplus.azure-mobile.net/api/registerOrganization",
          data: req,
		...
		alert("Sign Up Community"+e.message);
	}
}
